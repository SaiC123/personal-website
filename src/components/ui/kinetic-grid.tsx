...
/**
 * A cursor-reactive grid: warps toward the pointer and ripples on click.
 * Scoped to its own container (not the viewport), so it can sit inside a
 * single page section rather than behind the whole app.
 */
  ...
  return (
    <div
      ...
      className={cn(
        ...
        globalColor === "monochrome" ? "bg-[#000000]" : "bg-[#0c0d10]",
        className,
      )}
    >
