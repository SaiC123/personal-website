...
export interface CoverflowSlide {
  ...
  alt: string;
  title?: string;
  /** Makes `title` a link, e.g. to a detail page for this slide. */
  href?: string;
  subtitle?: string;
      ...
      {showCaption && active?.title && (
        ...
        >
          ...
          {active.href && (
            <Link
              href={active.href}
              className="mt-3 inline-flex items-center gap-1 rounded-full border border-border px-3 py-1.5 text-[12px] font-medium text-foreground transition-colors hover:border-brass hover:bg-accent"
            >
